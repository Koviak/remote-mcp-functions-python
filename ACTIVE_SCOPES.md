...
|---|---|---|---|---|
| AppCatalog.ReadWrite.All | Application | Read and write to all app catalogs | Yes |  Granted for Koviak Built |
| Application-RemoteDesktopConfig.ReadWrite.All | Application | Read and write the remote desktop security configuration for all apps | Yes |  Granted for Koviak Built |
| Application.ReadWrite.All | Application | Read and write all applications | Yes |  Granted for Koviak Built |
| Application.ReadWrite.OwnedBy | Application | Manage apps that this app creates or owns | Yes |  Granted for Koviak Built |
| Bookings.Manage.All | Delegated | Manage bookings information | No |  Granted for Koviak Built |
| Bookings.Read.All | Application | Read all Bookings related resources. | Yes |  Granted for Koviak Built |
| Bookings.ReadWrite.All | Delegated | Read and write bookings information | No |  Granted for Koviak Built |
| BookingsAppointment.ReadWrite.All | Application | Read and write all Bookings related resources. | Yes |  Granted for Koviak Built |
| Bookmark.Read.All | Delegated | Read all bookmarks that the user can access | No |  Granted for Koviak Built |
| Bookmark.Read.All | Application | Read all bookmarks | Yes |  Granted for Koviak Built |
| BrowserSiteLists.ReadWrite.All | Delegated | Read and write browser site lists for your organization | No |  Granted for Koviak Built |
| Calendars.ReadWrite | Application | Read and write calendars in all mailboxes | Yes |  Granted for Koviak Built |
| Calendars.ReadWrite.Shared | Delegated | Read and write user and shared calendars | No |  Granted for Koviak Built |
| Calls.AccessMedia.All | Application | Access media streams in a call as an app | Yes |  Granted for Koviak Built |
| Calls.Initiate.All | Application | Initiate outgoing 1 to 1 calls from the app | Yes |  Granted for Koviak Built |
| Calls.InitiateGroupCall.All | Application | Initiate outgoing group calls from the app | Yes |  Granted for Koviak Built |
| Calls.JoinGroupCall.All | Application | Join group calls and meetings as an app | Yes |  Granted for Koviak Built |
| Calls.JoinGroupCallAsGuest.All | Application | Join group calls and meetings as a guest | Yes |  Granted for Koviak Built |
| Channel.Create | Application | Create channels | Yes |  Granted for Koviak Built |
| Channel.Delete.All | Application | Delete channels | Yes |  Granted for Koviak Built |
| Channel.ReadBasic.All | Application | Read the names and descriptions of all channels | Yes |  Granted for Koviak Built |
| ChannelMember.ReadWrite.All | Application | Add and remove members from all channels | Yes |  Granted for Koviak Built |
| ChannelMessage.Read.All | Application | Read all channel messages | Yes |  Granted for Koviak Built |
| ChannelMessage.ReadWrite | Delegated | Read and write user channel messages | Yes |  Granted for Koviak Built |
| ChannelMessage.Send | Delegated | Send channel messages | No |  Granted for Koviak Built |
| ChannelMessage.UpdatePolicyViolation.All | Application | Flag channel messages for violating policy | Yes |  Granted for Koviak Built |
| ChannelSettings.ReadWrite.All | Application | Read and write the names, descriptions, and settings of all channels | Yes |  Granted for Koviak Built |
| Chat.Create | Delegated | Create chats | No |  Granted for Koviak Built |
| Chat.Create | Application | Create chats | Yes |  Granted for Koviak Built |
| Chat.ManageDeletion.All | Delegated | Delete and recover deleted chats | Yes |  Granted for Koviak Built |
| Chat.ManageDeletion.All | Application | Delete and recover deleted chats | Yes |  Granted for Koviak Built |
| Chat.Read.All | Application | Read all chat messages | Yes |  Granted for Koviak Built |
| Chat.Read.WhereInstalled | Application | Read all chat messages for chats where the associated Teams application is installed. | Yes |  Granted for Koviak Built |
| Chat.ReadBasic.All | Application | Read names and members of all chat threads | Yes |  Granted for Koviak Built |
...
| Files.ReadWrite.AppFolder | Application | Have full access to the application's folder without a signed in user. | Yes |  Granted for Koviak Built |
...
| OnlineMeetingArtifact.Read.All | Application | Read online meeting artifacts | Yes |  Granted for Koviak Built |
...
| SchedulePermissions.ReadWrite.All | Application | Read/Write schedule permissions for a role | Yes |  Granted for Koviak Built |
...
| TeamMember.ReadWriteNonOwnerRole.All | Application | Add and remove members with non-owner role for all teams | Yes |  Granted for Koviak Built |
...
| TeamsTab.Read.All | Delegated | Read tabs in Microsoft Teams. | Yes |  Granted for Koviak Built |
...
| User.ManageIdentities.All | Delegated | Manage user identities | Yes |  Granted for Koviak Built |
